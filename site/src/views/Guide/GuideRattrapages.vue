<template lang="">
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div class="w-full text-center pb-8">
            ...
            <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-1 pb-2">
                Différents cas de rattrapages
            </h1>
            <p class="text-3 font-normal text-base">
                Il existe beaucoup de cas de rattrapages. Si tu es perdu, cherche le cas qui te correspond le plus.
            </p>
        </div>
        <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-1 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    >
                    <div>
                        <p class="text-3xl text-1 font-normal mb-1">
                            CAS 1
                        </p>
                        <p class="text-base text-blue-600 font-normal">
                            - de 10 dans une matière
                        </p>
                    </div>
                </div>
                <div>
                    <p class="text-4 leading-loose font-normal text-base">
            ...
            <div class="bg-1 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-base text-blue-600 font-normal">
                            - de 10 dans une matière mais + de 10 dans un module
                        </p>
                    </div>
                </div>
                <div>
            ...
            <div class="bg-1 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    >
                    <div>
                        <p class="text-xl text-1font-normal mb-1">
                            CAS 6
                        </p>
                        <p class="text-base text-blue-600 font-normal">
                            Dev Ops
